...
export default function Resume() {
  ...
  const handleDownload = () => {
    if (selectedIndex === 0) {
      ...
      a.href = '/resume/PrinceVerma.pdf'
      a.download = 'PrinceVerma.pdf'
      document.body.appendChild(a)
      a.click()
      document.body.removeChild(a)
    } else {
      const a = document.createElement('a')
      a.href = '/resume/PrinceVerma_page-0001.jpg'
      a.download = '/PrinceVerma_page-0001.jpg'
      document.body.appendChild(a)
      a.click()
      document.body.removeChild(a)
    }
  ...
  const handleView = () => {
    if (selectedIndex === 0) {
      window.open('/resume/PrinceVerma.pdf', '_blank')
    } else {
      window.open('/resume/PrinceVerma_page-0001.jpg', '_blank')
    }
  }
    ...
    <Layout>
      <div className="w-full flex flex-col justify-center items-center my-[4.5rem]">
        ...
        >
          ...
          <img
            style={{
              boxShadow: '0px 0px 10px 0px rgba(92, 27, 27, 0.35)',
            }}
            className=""
            src="/resume/PrinceVerma_page-0001.jpg"
            alt=""
          />
          <div className="my-4">
            <ButtonGroup
